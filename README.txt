...
* Download and enable the Skinr module (NOTE: Skinr is still under heavy development. The skins for Acquia Prosper are not included in the 7x-dev version)
...
Skinr is not used with this 7x dev version.

Ubercart is not used with this 7x dev version.
