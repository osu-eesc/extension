	          ...
	          <div id="header-top-inner" class="header-top-inner inner clearfix">
                ...
                <div id="osu-top-hat">
                    <a href="http://oregonstate.edu/" title="Link to OSU homepage">
                        <img class="tag" src="http://oregonstate.edu/u_central/top-hat/images/osu-tag.gif" 
                        width="101px" height="119px" alt="Oregon State University" />
                    </a>
		        </div><!-- /osu-top-hat -->
                  ...
                  <div id="site-name-slogan" class="site-name-slogan">
                     <span id="site-name">
                        <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>">
                           <?php print $node->field_news_issue_reference[0]['view']; ?>
                        </a>
                     </span>	
                     ...
                     <div class="header-logo">
                        <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>">
                          ...
                          <!-- Serving IE6 a GIF, all other browsers PNG -->          
                          <?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE 6.0') !== FALSE) {
                                print '<img src="' . $base_path . $directory . '/images/eesc/logo-inside.gif" 
								alt="Oregon Land Grant University" />'; 
                            }
                            
                            else {
                                print '<img src="' . $base_path . $directory . '/images/eesc/logo-inside.png" 
								alt="Oregon Land Grant University" />';
                            } ?>
                  ...
                  <div id="main-content-inner" class="main-content-inner inner">
                    ...
                    <div id="content-group" class="content-group row nested <?php print $content_group_width; ?>">
                      <div id="content-group-inner" class="content-group-inner inner">
                        <?php // this is the orginal position for the crumb trail print theme('grid_block', $breadcrumb, 'breadcrumbs'); ?>
<?php print theme('grid_block', $tabs, 'content-tabs'); ?>
                        ...
                        <div id="content-region" class="content-region row nested">
                          <div id="content-region-inner" class="content-region-inner inner">
							<div class="story-category-<?php print($story_tid); ?>"><?php print($story_taxonomy) ?> 
                            	&nbsp; 
                            </div><!-- /story-category -->
