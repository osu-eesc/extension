...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  ...
  <div id="page" class="page">
                      ...
                      <div class="header-logo-front">
                         <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>">
                          ...
                          <?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE 6.0') !== FALSE) {
                                print '<img src="' . $base_path . $directory . '/images/eesc/logo.gif" 
								alt="Oregon Land Grant University" />'; 
                            }
                            
                            else {
                                print '<img src="' . $base_path . $directory . '/images/eesc/logo.png" 
								alt="Oregon Land Grant University" />';
                            } ?>
                            
                          </a>
                      </div><!-- /header-ext-logo-front -->
	...
	<div id="preface-top-wrapper" class="preface-top-wrapper full-width">
		<div id="preface-top" class="preface-top full-width">
